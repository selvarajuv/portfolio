...
import WoodGrainBackground from "./wood-grain-background"
...
export default function PageLayout({ children, activeSection = "home" }: PageLayoutProps) {
  ...
  useEffect(() => {
    const cleanup = setupParallaxEffect(backgroundRef, leftVinesRef, rightVinesRef)
    return cleanup
  }, [])
